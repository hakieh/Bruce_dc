...
# Pre-defined configs
##
from isaaclab_assets import G1_MINIMAL_CFG, BRUCE_CFG   # isort: skip


@configclass
class BeuceRwards(RewardsCfg):
...
@configclass
class BruceRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    rewards: BeuceRwards = BeuceRwards()
    ...
    def __post_init__(self):
        ...
        super().__post_init__()
        # Scene
        self.scene.robot = BRUCE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.dof_torques_l2.params["asset_cfg"] = SceneEntityCfg(
            "robot", joint_names=["hip_.*", "knee_.*", "ankle_.*"]
        )

...
BRUCE_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(   
        ...
        usd_path="/home/kh/hkh/code/isaaclab_pip_1/bruce_raw/bruce.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            'shoulder_roll_l' :-1.35,   # [rad]
            # 'elbow_pitch_l' :0.,   # [rad]
            'elbow_pitch_l' :-1.35,   # [rad]
            # 'shoulder_pitch_r' :0.35,   # [rad]
            'shoulder_pitch_r' :-0.35,   # [rad]
            # 'shoulder_roll_r' :-0.16,   # [rad]
            'shoulder_roll_r' :1.35,   # [rad]
            'elbow_pitch_r' :1.35,   # [rad]
        },
        joint_vel={".*": 0.0},
    ),
